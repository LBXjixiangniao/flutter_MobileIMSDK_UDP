...
import 'package:flutter_MobileIMSDK/method.dart';
import 'package:flutter_MobileIMSDK_example/custom_dialog.dart';
...
class _MobileIMSDKLoginPageState extends State<MobileIMSDKLoginPage> {
  ...
  void login() {
    if (ipController.text.isEmpty || portController.text.isEmpty) {
      ...
      FlutterMobileIMSDK.initMobileIMSDK(
              serverIP: ipController.text, serverPort: int.parse(portController.text), debug: true)
          .then((value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StatefulBuilder(builder: (ctx, _) {
